<?php namespace App\Http\Controllers;
	...
	class AdminStudentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nim','name'=>'nim','type'=>'text','validation'=>'required|min:1|max:10','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Angkatan","name"=>"angkatan","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
