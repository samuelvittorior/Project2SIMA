<?php namespace App\Http\Controllers;
	...
	class AdminDosenController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Makul","name"=>"makul"];
			...
			$this->form[] = ['label'=>'Makul','name'=>'makul','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Makul","name"=>"makul","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
